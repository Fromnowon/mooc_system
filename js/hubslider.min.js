...
jQuery.fn.hubSlider = function (t) {
    ...
    try {
        ...
        (null === e.selector || "" == e.selector) && console.error("Error, specify selector!"), r.find(e.selector).each(function (t) {
            ...
            }).attr("data-key", t), e.scale = e.scale - e.scaleStep, n -= 0 === t ? t + 1 : t, e.offset = e.offset + e.startOffset, t + 1 <= r.find(e.selector).length && (r.find(e.selector).eq(t).css({opacity: e.opacity}), e.opacity = e.opacity - e.opacityStep)
        });
        var a = function (t) {
